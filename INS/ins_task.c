...
void TIM_Set_PWM (TIM_HandleTypeDef *tim_pwmHandle, uint8_t Channel, uint16_t value)
{
  ...
  switch (Channel)
	{
	  case TIM_CHANNEL_1: tim_pwmHandle->Instance->CCR1 = value;
	  break;
	  case TIM_CHANNEL_2: tim_pwmHandle->Instance->CCR2 = value;
	  break;
	  case TIM_CHANNEL_3: tim_pwmHandle->Instance->CCR3 = value;
	  break;
	  case TIM_CHANNEL_4: tim_pwmHandle->Instance->CCR4 = value;
	  break;
	  default: break;
	}
}
void IMU_Temperature_Ctrl (void)
{
  ...
  TIM_Set_PWM (&htim10, TIM_CHANNEL_1, float_constrain (float_rounding (TempCtrl.Output), 0, (float) UINT32_MAX));
}
